...
# print(student_admission_info)
reg_no = ['001','002','003','004','005','006','007','008','009','010']
student_names =  ['Edu','Helen','Chike','Chike','Chike','Chike','Chike','Chike','Chike','Chike',]
student_info  = {}

for k, v in zip(reg_no,student_names):
    print(k,v)
    student_info[k] = v
    print(student_info)